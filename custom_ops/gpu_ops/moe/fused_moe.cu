...
void FusedMoeKernel(const paddle::Tensor& input,
    ...
    auto fp16_moe_gemm_runner = MoeGemmRunner<DataType_, WintQuantTraits<DataType_, WintQuantMethod::kNone>>();
    auto int8_moe_gemm_runner = MoeGemmRunner<DataType_, WintQuantTraits<DataType_, WintQuantMethod::kWeightOnlyInt8>>();
    auto int4_moe_gemm_runner = MoeGemmRunner<DataType_, WintQuantTraits<DataType_, WintQuantMethod::kWeightOnlyInt4>>();
