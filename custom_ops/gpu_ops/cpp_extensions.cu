...
PYBIND11_MODULE(efficientllm_ops, m) {
     ...
     */
    m.def("gqa_rope_write_cache", &GQARopeWriteCacheKernel, "gqa rope write cache function");
    /**
     * pre_cache_len_concat.cu
     * pre_cache_len_concat
     */
    m.def("pre_cache_len_concat", &PreCacheLenConcat, "pre_cache len concat function");
    /**
     ...
     * moe_expert_dispatch
     */
    m.def("moe_expert_dispatch", &MoeExpertDispatch,
           py::arg("input"), py::arg("gating_output"),
           py::arg("gating_correction_bias"), py::arg("moe_topk"),
           py::arg("group_moe"), py::arg("topk_only_mode"),
     ...
     * ep_moe_dispatch
     */
    m.def("ep_moe_expert_dispatch", &EPMoeExpertDispatch,
           py::arg("input"), py::arg("topk_ids"),
           py::arg("topk_weights"), py::arg("ffn1_in_scale"),
    ...
    m.def("ep_moe_expert_dispatch_fp8", &EPMoeExpertDispatchFP8,
           ...
           py::arg("topk_weights"), py::arg("token_nums_per_expert"),
           py::arg("token_nums_per_expert_padded"), py::arg("token_nums_this_rank"), py::arg("token_nums_this_rank_padded"),
           "ep moe export dispatch function");

    m.def("ep_moe_expert_combine", &EPMoeExpertCombine,
           py::arg("ffn_out"), py::arg("expert_scales_float"),
    ...
    m.def("per_token_quant_padding", &PerTokenQuantPadding,
           py::arg("input"), py::arg("block_size"),
           "per token per block quant and padding tranpose scale");

    m.def("masked_per_token_quant", &MaskedPerTokenQuant,
            py::arg("input"), py::arg("recv_expert_count"), py::arg("block_size"),
            "per token per block quant");
     ...
     * moe_topk_select
     */
    m.def("moe_topk_select", &MoETopKSelectKernel,
     ...
     * moe_expert_reduce
     */
    m.def("moe_expert_reduce", &MoeExpertReduceFunc,
           py::arg("ffn_out"), py::arg("top_k_weight"),
           py::arg("permute_indices_per_token"), py::arg("top_k_indices"),
           py::arg("ffn2_bias"), py::arg("norm_topk_prob"),
           py::arg("routed_scaling_factor"), "moe export reduce function");
     ...
     */
    m.def("init_signal_layerwise", &InitSignalLayerwiseFunc, "init_signal_layerwise function");
     ...
     */
    // m.def("f_get_block_shape_and_split_kv_block", &GetBlockShapeAndSplitKVBlock, "get_block_shape_and_split_kv_block function");
     ...
     * get_padding_offset
     */
    m.def("set_value_by_flags_and_idx", &SetValueByFlagsAndIdx, "SetValueByFlagsAndIdx");
     ...
     */
    m.def("set_stop_value_multi_ends", &GetStopFlagsMulti, "update_inputs function");

    /**
     * stop_generation_multi_stop_seqs.cu
     * set_stop_value_multi_seqs
     */
    m.def("set_stop_value_multi_seqs", &GetStopFlagsMultiSeqs, "update_inputs function");
