...
export FD_MODEL_NAME="2"


rm -rf ./log*

python fastdeploy/entrypoints/openai/api_server.py --config fastdeploy/agent_work.yaml --port 9809 --engine-worker-queue-port 9091 --tensor-parallel-size 2
