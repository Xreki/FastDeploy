...
# Original source: https://github.com/vllm-project/vllm/blob/main/benchmarks/benchmark_dataset.py
...
def lora_path_on_disk(lora_path: str) -> str:
    """Get the absolute path to the given LoRA parameter file"""
...
class RandomDataset(BenchmarkDataset):
    """A synthetic dataset class that generates random sequences."""
