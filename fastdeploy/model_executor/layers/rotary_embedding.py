...
def get_rope(
    ...
    if model_config is None or "Qwen2ForCausalLM" in model_config.architectures or "Qwen3MoEForCausalLM" in model_config.architectures:
...
class RopeEmbedding:
    ...
    def get_neox_style_position_embedding(position_ids, head_dim, base):
        ...
        rot_emb = paddle.zeros((2, bsz, max_seq_len, 1, head_dim),
                            dtype="float32")
        inv_freq = base**(-paddle.arange(0, head_dim, 2, dtype="float32") / head_dim)
