...
"""
This file contains the triton ops for fused_moe_kernel
"""
import paddle
...
def invoke_fused_moe_kernel(
    ...
    # nnum_valid_tokens = topk_ids.shape[0] * topk_ids.shape[1]
...
def moe_wint2_ffn_kernel(
    ...
    # idx = tl.arange(0, 4)
    # shift_table = 9 - idx * 3
    # b_shift_bits = shift_table + (offs_k[:, None] % 4)
    # pack shift
