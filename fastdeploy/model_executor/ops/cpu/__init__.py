...
import_custom_ops(PACKAGE, ".efficientllm_cpu_ops", globals())

rename_imported_op(
    old_name="update_inputs_cpu",
    new_name="update_inputs",
    global_ns=globals(),
)
rename_imported_op(
    old_name="get_token_penalty_multi_scores_cpu",
    new_name="get_token_penalty_multi_scores",
    global_ns=globals(),
)
rename_imported_op(
    old_name="set_stop_value_multi_ends_cpu",
    new_name="set_stop_value_multi_ends",
    global_ns=globals(),
)
rename_imported_op(
    old_name="set_value_by_flags_and_idx_cpu",
    new_name="set_value_by_flags_and_idx",
    global_ns=globals(),
)
rename_imported_op(
    old_name="get_padding_offset_cpu",
